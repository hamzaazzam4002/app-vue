      ...
      <v-row>
        <v-col cols="7">
          ...
          >
            ...
            <!-- Start breadcrumbs -->
            <v-breadcrumbs
              :items="['Cart', 'imformation', 'Shipping', 'payment']"
            ...
            <v-card-actions
              class="d-flex justify-space-between align-ccenter mb-7"
            >
              <v-btn
                color="#3742fa"
                variant="elevated"
              ...
              <v-btn
                ...
                height="45"
              >
                <svg width="80" height="17" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
              class="user-info d-flex justify-center align-center"
              style="gap: 20px"
            >
              <input
            ...
            />
            <div
              class="city-info-info d-flex justify-center align-center"
              style="gap: 20px"
            >
              <input
                type="text"
            ...
            <v-divider width="100%" color="#000"></v-divider>
            <v-divider width="100%" color="#000"></v-divider>
            <v-card-text style="font-size: 12px; color: #444">
        ...
        <v-col cols="5">
          ...
          >
            ...
            >
              <v-badge :content="item.Quantitiy" color="grey-darken-2">
                <img
                  :src="item.thumbnail"
                  alt=""
                  width="50"
              ...
              <div class="title flex-grow-1">
                <v-card elevation="0" color="transparent">
                  ...
                  >
                    ...
                    sale</v-card-text
                  >
                  <v-card-text style="font-size: 12px; color: #333"
                    >{{ item.category }}
                  </v-card-text>
                </v-card>
              </div>
...
import OrderSuccess from "../components/global/OrderSuccess";
