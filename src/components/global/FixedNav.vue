        ...
        <v-row>
          ...
          <v-col cols="7">
            <ul
              ...
              class="d-flex justify-space-between align-center text-white ml-3"
            >
          ...
          >
            ...
            <svg
              ...
              :style="`width: 30; fill: #ffdd40; margin-right: 10px;cursor: pointer;pointer-events:${
                $route.name == 'cart_page' ? 'none' : 'unset'
              }`"
              @click="OpenCard"
            >
