<template>
  <div class="nav-bar">
    <v-app-bar color="#5352ed" height="fit-content" absolute>
      ...
      <v-container fluid class="py-5">
        <v-row class="d-flex align-center">
          ...
          <!--USer options -->
          <v-col cols="5">
            <div class="parent pr-5">
              <v-row class="d-flex justify-space-between align-center">
                <div>
                  <span>Available 24/7 at</span>
                  <br />
                  <strong>(090) 123-456</strong>
                </div>
                <div
                  cols="3"
                  class="d-flex flex-column align-center text-#FFDD40"
                >
                  <svg
                    viewBox="0 0 512 512"
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                  ...
                  <span style="color: #ffdd40">wish lists</span>
                </div>

                <div cols="3" class="d-flex flex-column align-center">
                  <svg
                  ...
                  <span style="color: #ffdd40">Sign In</span>
                </div>
                <div
                  cols="3"
                ...
                >
                  ...
                  <span style="color: #ffdd40">Card</span>
                </div>
              </v-row>
            </div>
          </v-col>
        ...
        <v-row class="mt-6">
          <v-col cols="7">
            <ul
              ...
              class="d-flex text-white justify-space-between align-center pl-8"
            >
          ...
          <v-col cols="5" class="d-flex justify-end" style="gap: 25px">
