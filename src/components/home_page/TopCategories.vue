<template>
  <div class="top-categores">
    <div class="cyber-banner">
      <img src="@/assets/images/cyber-banner.webp" class="w-100" alt="" />
    </div>
    <div class="categories">
      <div class="title d-flex justify-center align-center pa-16">
        <h2
              ...
              <v-hover v-slot="{ isHovering, props }">
                ...
                >
                  <img
                    ...
                    alt=""
                    v-bind="props"
                    :style="`cursor: pointer;height: 100% ;width: 100%;transition:all .5s ease-in-out;scale:${
                      isHovering ? 1.05 : 1
                    }`"
                  />
                </div>
