<template>
  <div class="quality py-12 bg-grey-lighten-3">
    <v-container>
      <v-row>
        <v-col
          cols="12"
        ...
        >
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              ...
              :color="isHovering ? 'blue-lighten-1' : 'white'"
      ...
      cards: [
        {
          ...
          desc: "comperhensive quality control and afforadble prices",
          svg: `
            <svg
              style='width:60px'
              aria-hidden="true"
        ...
        {
          title: "fast shipping",
          desc: "fat and convenient door to door delivery",
          svg: `
            <svg
             style='width:60px'
              aria-hidden="true"
